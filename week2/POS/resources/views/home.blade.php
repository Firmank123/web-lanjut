...
<div class="container-fluid px-4">
    ...
    <div class="hero-section text-center py-5 mb-5 rounded-lg bg-gradient position-relative overflow-hidden">
        ...
        <div class="position-relative">
            <h1 class="display-3 fw-bold text-white mb-3">POS M. Firmansyah</h1>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="dashboard-card h-100 rounded-4 border-0">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('user.profile', ['id' => '2341720099', 'name' => 'M. Firmansyah']) }}" class="btn btn-info w-100 btn-modern">
